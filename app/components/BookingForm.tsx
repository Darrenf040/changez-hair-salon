...
export default function BookingForm({ selectedDate, selectedTime, onBack, onSuccess }: BookingFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setSubmitMessage('Appointment request submitted successfully! We will contact you to confirm.');
            // Reset form
            setFormData({
                name: '',
                email: '',
                        ...
                        <div>
                            ...
                            {formData.services.length > 0 && (
                                <div className="mt-4 text-right space-y-1">
                                    <p className="text-sm text-gray-600">
                                        Total Duration: <span className="font-medium">{calculateDuration()} minutes</span>
                                    </p>
                                    <p className="text-sm text-gray-600">
